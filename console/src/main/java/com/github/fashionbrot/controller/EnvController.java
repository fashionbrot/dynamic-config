...
public class EnvController  {
    ...
    @GetMapping("/page")
    @ResponseBody
    public Response pageReq(EnvRequest req) {
    ...
    @PostMapping("/insert")
    @ResponseBody
    public Response add(@RequestBody EnvEntity entity){
        service.save(entity);
    ...
    @ResponseBody
    public Response updateById(@RequestBody EnvEntity entity){
